...
@dso_cache = dso_local local_unnamed_addr global [48 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 724761128570607164, ; hash 0xa0ede680f76563c, from name: ikvm.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libikvm.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2555220389115620061, ; hash 0x2375f767e0126add, from name: libikvm
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libikvm.so
		ptr null; void* handle (0x0)
	}, ; 4
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libMono.Unix.so
		ptr null; void* handle (0x0)
	}, ; 6
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7027046612320756042, ; hash 0x618515a9bb7da14a, from name: ikvm
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libikvm.so
		ptr null; void* handle (0x0)
	}, ; 18
	...
	%struct.DSOCacheEntry {
		i64 7968521328725962694, ; hash 0x6e95dfedefd5afc6, from name: libikvm.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libikvm.so
		ptr null; void* handle (0x0)
	}, ; 24
...
@.env.7 = private unnamed_addr constant [37 x i8] c"78a15581-1890-4d80-a081-74275f7c014d\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.appempresa\00", align 1
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [11 x i8] c"libikvm.so\00", align 1
@.DSOCacheEntry.10_name = private unnamed_addr constant [16 x i8] c"libMono.Unix.so\00", align 1
