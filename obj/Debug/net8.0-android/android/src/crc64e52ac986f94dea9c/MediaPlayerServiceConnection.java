...
public class MediaPlayerServiceConnection
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MauiAudio.Platforms.Android.MediaPlayerServiceConnection, MauiAudio", MediaPlayerServiceConnection.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MediaPlayerServiceConnection.class) {
			mono.android.TypeManager.Activate ("MauiAudio.Platforms.Android.MediaPlayerServiceConnection, MauiAudio", "", this, new java.lang.Object[] {  });
		}
	}
