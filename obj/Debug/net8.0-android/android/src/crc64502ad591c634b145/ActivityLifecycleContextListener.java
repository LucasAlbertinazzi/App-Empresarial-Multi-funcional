...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MauiAudio.Platforms.Android.CurrentActivity.ActivityLifecycleContextListener, MauiAudio", ActivityLifecycleContextListener.class, __md_methods);
	}
	...
	public ActivityLifecycleContextListener ()
	{
		...
		if (getClass () == ActivityLifecycleContextListener.class) {
			mono.android.TypeManager.Activate ("MauiAudio.Platforms.Android.CurrentActivity.ActivityLifecycleContextListener, MauiAudio", "", this, new java.lang.Object[] {  });
		}
	}
